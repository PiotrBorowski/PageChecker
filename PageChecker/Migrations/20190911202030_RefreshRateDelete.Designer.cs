...
namespace PageCheckerAPI.Migrations
{
    ...
    [Migration("20190911202030_RefreshRateDelete")]
    partial class RefreshRateDelete
    {
            ...
            modelBuilder.Entity("PageCheckerAPI.Models.Page", b =>
                {
                    ...
                    b.Property<int>("RefreshRate2");

                    b.Property<Guid>("SecondaryTextId");
            ...
            modelBuilder.Entity("PageCheckerAPI.Models.Page", b =>
                {
                    ...
                    b.HasOne("PageCheckerAPI.Models.WebsiteText", "SecondaryText")
                        .WithMany()
                        .HasForeignKey("SecondaryTextId")
                        .OnDelete(DeleteBehavior.Cascade);
